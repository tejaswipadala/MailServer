...
if(isset($_POST['pwdchg']))
{
	...
	{
		$r=mysqli_query($con, "SELECT * FROM stuinfo where userName='{$_SESSION['sname']}'");
		$row=mysqli_fetch_object($r);
		if($row->pass==$_POST['op'])
		{
			if($_POST['np']==$_POST['cp'])
			{
			$upd=mysqli_query($con,"UPDATE stuinfo SET pass='{$_POST['np']}' where userName='{$_SESSION['sname']}'");
			echo "pass updated";
			}
			else
			{
...
<font color="#FF0000"><?php echo $err; ?></font>
  ...
  <tr>
    <td>Enter Your confirmed passwrod </td>
    <td>
